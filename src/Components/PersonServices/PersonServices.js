    ...
    setService_Content([
      {
        ...
        Paragraph:
          "من خلال توكيل محام مرخص يكفل نظام الإجراءات الجزائية الحق للشخص الدفاع عن نفسه أثناء الاتهام باستغلال النفوذ الوظيفي. أو اختلاس وتبديد المال العام في ظل أحكام نظام مكافحة الرشوة ونظام مكافحة جرائم التزوير والأنظمة الجزائية الأخرى",
      },
      {
        title: "قضايا المخدرات والمؤثرات العقلية",
        icon: <GiStabbedNote className={styles.icon} />,
        Paragraph:
          "من خلال توكيل محام مرخص يكفل نظام الإجراءات الجزائية الحق القانوني للأفراد الذين يتهمون بحيازة أو ترويج المخدرات وتهريبها الدفاع عن أنفسهم في ظل أحكام نظام مكافحة المخدرات والمؤثرات العقلية والأنظمة الجزائية الأخرى ، والقواعد القضائية والقانونية ذات الصلة",
      },
      {
      ...
      },
      {
        ...
        Paragraph:
          "تقديم الاستشارات فيما يتعلق بتأجير وشراء  وبيع العقارات، والتعامل مع النزاعات المتعلقة بها",
      },
      {
        title: "قضايا الأحوال الشخصية",
        icon: <BsFileMedical className={styles.icon} />,
        Paragraph:
          "التعامل مع قضايا ودعاوى الأحوال الشخصية الزواج، الطلاق، الخلع، الحضانة، النفقة، وغيرها من القضايا التي تتعلق بالأحوال الشخصية.",
      },
      {
        title: "القضايا الإدارية",
        icon: <FaUserPen className={styles.icon} />,
        Paragraph:
          "التعامل مع القضايا التي تتعلق بالقرارات الإدارية للعاملين لدى الجهات العامة والاعتراض عليها في | ظل نظام المرافعات أمام ديوان المظالم والأنظمة الإدارية الأخرى، سواء تتعلق بقرارات حكومية أو قضايا مع جهات إدارية أخرى",
      },
      {
        title: "نظام الشركات",
        icon: <ImBriefcase className={styles.icon} />,
        Paragraph:
          "تقديم الاستشارات القانونية للأفراد فيما يخص تأسيس الشركات وإدارتها، أو حل النزاعات التي قد تنشأ بين الشركاء",
      },
    ]);
  }, []);
