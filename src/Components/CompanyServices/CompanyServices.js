...
const CompanyServices = () => {
  ...
  return (
    <Fragment>
            ...
            <h1 data-aos="fade-down">خدمات الشركات</h1>
        <div  data-aos="fade-left"  data-aos-anchor="#example-anchor" data-aos-offset="500" data-aos-duration="700"  className={styles.Service_companyJunior}>
